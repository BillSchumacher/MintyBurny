...
contract MintyBurnyTest is Test {
    ...
    function testBurnedFromIncreases() public {
        ...
        assertTrue(
            mintyBurny.burnedFrom(vm.addr(1)) - burnedFrom == 10000 * 10 ** mintyBurny.decimals()
        );
        assertTrue(
            mintyBurny.burnedFrom(address(0)) == 0
        );
        vm.prank(vm.addr(1));
        ...
        assertTrue(
            mintyBurny.burnedFrom(vm.addr(1)) - burnedFrom == 20000 * 10 ** mintyBurny.decimals()
        );
        assertTrue(
            mintyBurny.balanceOf(vm.addr(1)) == 0
        );
    ...
    function testMintForIncreases() public {
        ...
        assertTrue(
            mintyBurny.mintedBy(vm.addr(2)) - minted == 20000 * 10 ** mintyBurny.decimals()
        );
    }
    ...
    function testTotalMintedIncreases() public {
        ...
        assertTrue(
            mintyBurny.totalMinted() - totalMinted == 10000 * 10 ** mintyBurny.decimals()
        );
    }
    ...
    function testTotalBurnedIncreases() public {
        ...
        mintyBurny.burn(10000 * 10 ** mintyBurny.decimals());
        assertTrue(
            mintyBurny.totalBurned() - totalBurned == 10000 * 10 ** mintyBurny.decimals()
        );
    }
