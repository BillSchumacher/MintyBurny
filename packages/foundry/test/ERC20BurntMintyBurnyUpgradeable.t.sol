...
import {ERC20MintyBurnyUpgradeable} from
    "../contracts/token/ERC20Upgradeable/examples/ERC20MintyBurnyUpgradeable.sol";
import {ERC20BurntMintyBurnyUpgradeable} from
    "../contracts/token/ERC20Upgradeable/examples/ERC20BurntMintyBurnyUpgradeable.sol";
...
contract TestBurntMintyBurnyUpgrade is Test {
    ERC20MintyBurnyUpgradeable public mintyBurny;
    ERC20BurntMintyBurnyUpgradeable public burntMintyBurny;

    function setUp() public {
        mintyBurny = new ERC20MintyBurnyUpgradeable();
        mintyBurny.initialize();
        address[] memory burnAddresses = new address[](1);
        burnAddresses[0] = address(0);
        address[] memory contractAddresses = new address[](1);
        contractAddresses[0] = address(mintyBurny);
        burntMintyBurny = new ERC20BurntMintyBurnyUpgradeable();
        burntMintyBurny.initialize(burnAddresses, contractAddresses);
    }
