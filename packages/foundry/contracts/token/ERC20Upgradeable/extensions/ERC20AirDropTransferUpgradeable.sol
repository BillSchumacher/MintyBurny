...
abstract contract ERC20AirDropTransferUpgradeable is
    Initializable,
    ERC20Upgradeable
{
    ...
    function __ERC20AirDropTransfer_init() internal onlyInitializing {
        __ERC20AirDropTransfer_init_unchained();
    }

    function __ERC20AirDropTransfer_init_unchained()
        internal
        onlyInitializing
    {}
