...
abstract contract ERC20ProofOfRegistryMinter is
    Context,
    ERC20,
    ERC20ExternalMintRegistry
{
        ...
        returns (uint256 balance)
    {
        ...
        IMultiTokenMintRegistry registryContract =
            IMultiTokenMintRegistry(_mintRegistry);
        for (uint256 i; i < contractLength;) {
            balance +=
                registryContract.mintedBy(eligibleMinterContracts[i], sender);
            unchecked {
                ++i;
            }
        }
